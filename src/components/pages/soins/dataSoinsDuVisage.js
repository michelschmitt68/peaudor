export const title = [
  ...
  export const description = [
    `Offrez à votre peau un soin revitalisant et personnalisé. 
    Nos soins du visage sont conçus pour répondre à vos besoins 
    spécifiques et raviver l'éclat de votre peau. Profitez d'un traitement 
    sur mesure pour améliorer l'apparence et la santé de votre visage.`
  ];


  export const tarifs = [
    { name: "Soin Visage Bonne Mine (30 min)", price: "34€" },
    { name: "Soin Sur Mesure (1h)", price: "59€" },
  ...
  export const questions = [
    {
      question: "Quelle est la différence entre les soins visage bonne mine, soins visage sur mesure, soins visage purifiant, rituel anti-âge et soin peeling ?",
      answer: `
